...
parser.add_argument('--source_file', type=str, help='path to the source image')
parser.add_argument('--mask_file', type=str, help='path to the mask image')
parser.add_argument('--target_file', type=str, help='path to the target image')
